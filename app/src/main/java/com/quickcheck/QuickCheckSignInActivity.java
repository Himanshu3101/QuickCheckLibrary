...
import com.quickcheck.model.MyRequest;
...
public class QuickCheckSignInActivity extends AppCompatActivity {
    ...
    public String jsonMandateData(String SponsorBank, String DebitType, String Frequency, String ToDebit,
    ...
    public void initCredential(String EmailId, String AppId, String Password) {
        dologin(QuickCheckSignInActivity.this, EmailId, AppId, Password);
    }
    ...
    public void dologin(final Activity activity, final String useridd, final String appid, final String passwordd) {
        ...
        Toast.makeText(activity, new JSONObject(
                params).toString(), Toast.LENGTH_SHORT).show();
        MyRequest req = null;
        final MyRequest finalReq = req;
        req = new MyRequest(Serverfuction.login, new JSONObject(
