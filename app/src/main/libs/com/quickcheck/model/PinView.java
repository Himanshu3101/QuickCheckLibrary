...
public class PinView extends AppCompatEditText {
    ...
    private int mCurLineColor = getResources().getColor(R.color.grey);
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPinItemHeight = (int) a.getDimension(R.styleable.PinView_itemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_size));
        ...
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PinView_itemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin__spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.PinView_itemRadius,  res.getDimensionPixelSize(R.dimen.pv_pin_itemRadius));
        ...
        mCursorColor = getResources().getColor(R.color.colorAccent);
